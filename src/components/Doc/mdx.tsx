...
import { Feedback } from "src/components/Doc/Feedback";
import { Heading } from "src/components/Doc/Heading";
import { Prose } from "src/components/Doc/Prose";

export const a = Link;
export { Button } from "src/components/Doc/Button";
export { CodeGroup, Code as code, Pre as pre } from "src/components/Doc/Code";
